...
Solving the equation above will get us 5.05, and by converting it with the use of z-table we'll get 0.99, which is our β-error.
...
**Test Statistic:** 
        ...
        Z(0) = x̄(1) - x̄(2) - 0 / √((σ(1)^2/n) + (σ(2)^2/n))
